...
def skip_django_descriptors(app, what, name, obj, skip, options):
    if isinstance(obj, (ReverseManyToOneDescriptor, ReverseOneToOneDescriptor, ForeignKeyDeferredAttribute)):
        return True
    return skip
...
os.environ['DJANGO_SETTINGS_MODULE'] = 'modulesProject.settings'
django.setup()
