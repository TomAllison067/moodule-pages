...
class MyTestCase(TransactionTestCase):
    def setUp(self):
        ...
        m.save()
        self.newstrand = Strands(module=Module.objects.first(), strand='CM')
    ...
    def test_same_code_diff_strand(self):
        ...
        """
        self.newstrand.save()
        another_strand = Strands(module=Module.objects.first(), strand='HH')
        another_strand.save()
    ...
    def test_db_query(self):
        ...
        Strands(module=Module.objects.first(), strand='HH').save()  # saving new strand object, total number of record should be 2
