...
class TestQueries(TestCase):
    def test_db_strand_query(self):
        ...
        Strands.objects.create(module=m, strand='SE')
        self.assertEqual(1, Strands.objects.count(), "One strands added.")
        Strands(module=m,
                strand='IS').save()  # saving new strand object, total number of record should be 2
        ...
        third_strand = Strands(module=new_module, strand='AI')  # new stand object
        ...
        self.assertEqual(Strands.objects.filter(module='CS7432').first().strand, 'AI')
