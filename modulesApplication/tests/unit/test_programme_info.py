...
class TestProgrammeInfo(TestCase):
    ...
    def test_programme_object(self):
        ...
        Programme.objects.create(prog_code='foo', level='bsc')
        p = factory.get_programme_info(prog_code='foo', entry_year='2019', stage=1)
    ...
    def test_entry_year(self):
        ...
        Programme.objects.create(prog_code='madeup', level='BSc')
        p = factory.get_programme_info(prog_code='madeup', entry_year='2019', stage=1)
        expected = '2019'
